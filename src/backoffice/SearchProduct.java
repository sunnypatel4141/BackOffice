 ...
 * @author Sunny Patel
 */
public class SearchProduct extends Products {
    ...
    JCheckBox quickKeysBox = new JCheckBox("Quick Keys Only");
        ...
        editBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if(selectedRow == -1) {
                    ...
                    EditProduct ep = new EditProduct(productID, EDIT_VIA_PRODUCT_ID);
                }
            }
        });
    ...
    private void searchProduct() {
        ...
        String morewhere = "";
        if (quickKeysBox.isSelected()) {
            morewhere += " and pr.qk = '1' ";
        }
        ...
        try {
            String sql = "select pr.id, pr.name, mc.name, sc.name, pp.price from product pr" +
                ...
                " where pp.qty='1' and pr.name like ? " + morewhere
                    + "limit 50";
